...
public class DSE : IDSE, IRunCipher
{
    ...
    private int[] clst = {1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1};

    //Circular Right shift Table (For Decryption)  
    private int[] crst = {1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1, 1};
